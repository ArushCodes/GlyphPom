...
GlyphPom combines the classic Pomodoro productivity technique with the high-contrast design language of Nothing OS. It utilizes the **Nothing Ketchum SDK** to provide ambient, non-intrusive feedback via the Glyph Interface.

---

## ✨ Features (Hardware-Integrated)
...
| **Active Focus** | **Rest Phase** | **Advanced Settings** |
| :---: | :---: | :---: |
| <img src="screenshots/2503.png" width="240"> | <img src="screenshots/2505.png" width="240"> | <img src="screenshots/2506.png" width="240"> |
| *Dot-matrix timer UI* | *Green accent rest mode* | *Toggle hardware features* |

| **Home Page** |
| :---: |
| <img src="screenshots/2504.png" width="240"> |
| *Set your work/rest cycles* |
